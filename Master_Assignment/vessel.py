...
class Vessel:
    ...
    def __init__(self, imo: int, mmsi: int | None, name: str, country: str, type: str, build: int, gross: int, netto: int, length: int, beam: int) -> None:
        self.imo = imo
        self.mmsi = mmsi
        self.name = name
...
# print(vessel.get_fuel_consumption(1000))
